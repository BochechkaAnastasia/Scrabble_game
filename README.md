...
Игра Scrabble (Скрабл) — это классическая настольная игра, в которой игроки соревнуются в составлении слов на игровом поле 15×15 клеток. Цель игры — набрать максимальное количество очков, используя буквы с разной стоимостью и бонусные клетки.
...
- **Поле 15×15** с бонусными клетками:
  ...
  - 🔷 Тёмно-синие клетки — утроение буквы
...
- **Ход игры**:
  - Первое слово должно проходить через центр (клетка 7,7)
...
git clone https://github.com/your-username/ScrabbleGame.git
cd ScrabbleGame
